...
// segmentations
const currentSegmentationEnabledCheckbox = {{enable_content_generation_segmentation.value}}
currentConfig.content_generation.is_segmentation_enabled = currentSegmentationEnabledCheckbox

const ticketSegmentations = {{segmentations_editor.value}}
if(ticketSegmentations) {
  currentConfig.content_generation.ticket_segmentations = ticketSegmentations
}
const articleSegmentations = {{ segmentations_editor2.value }}
if(articleSegmentations) {
  currentConfig.content_generation.article_segmentations = articleSegmentations
}
