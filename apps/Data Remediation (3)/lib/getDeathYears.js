...
const minDate = new Date(
 ...
 // Maximum Death Start Date (current date)
...
const yearFromAPI = CurrentSelectedContact.value.personalInfo.item.death && CurrentSelectedContact.value.personalInfo.item.death.date ? new Date(CurrentSelectedContact.value.personalInfo.item.death.date).getUTCFullYear() : null
