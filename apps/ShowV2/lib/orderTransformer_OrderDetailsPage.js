...
data["coupon_is_global"] = {{queryIsGlobalCoupon_OrderDetailsPage.data}}["is_global"][0];
...
let sellerCancellation = {{ querySellerOrderCancellationReason_OrderDetailsPage.data }};
