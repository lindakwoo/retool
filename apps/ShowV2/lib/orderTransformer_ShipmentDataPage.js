...
data["coupon_is_global"] = {{queryIsGlobalCoupon_ShipmentDataPage.data}}["is_global"][0];
...
let sellerCancellation = {{ querySellerOrderCancellationReason_ShipmentDataPage.data }};
