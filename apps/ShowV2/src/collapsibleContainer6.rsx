...
>
  ...
  <View id="fbfcf" viewKey="View 1">
    ...
    <TextInput
      id="street_two_seller_crtsl"
      _disclosedFields={{ array: [] }}
      label="Street 2"
      marginType="normal"
      readOnly="{{ labelGenerationFailureMessage }}"
    ...
    <TextInput
      id="state_seller_crtsl"
      _disclosedFields={{ array: [] }}
      customValidation={
        '{{((country.value != "US" && country.value != "CA") || state_seller_crtsl.value != "") ? null : "State Required" }}'
      }
      label="State"
      marginType="normal"
      placeholder="Enter value"
