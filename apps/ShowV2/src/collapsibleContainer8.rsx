...
>
  ...
  <View id="fbfcf" viewKey="View 1">
    ...
    <TextInput
      ...
      _disclosedFields={{ array: [] }}
      customValidation={
        '{{((country.value != "US" && country.value != "CA") || state_crtsl2.value != "") ? null : "State Required" }}'
      }
      label="State"
      marginType="normal"
      placeholder="Enter value"
    ...
    >
      ...
      <Event
        ...
        method="run"
        params={{
          ordered: [{ src: "phone_crtsl2.setValue(phoneFormat(self.value))" }],
        }}
        pluginId=""
        type="script"
        waitMs="0"
