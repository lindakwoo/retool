...
data["coupon_is_global"] = {{queryIsGlobalCoupon_ShippingAdjustmentsPage.data}}["is_global"][0];
...
let sellerCancellation = {{ querySellerOrderCancellationReason_ShippingAdjustmentsPage.data }};
