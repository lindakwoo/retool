<App>
  ...
  <DocumentTitle id="$customDocumentTitle" value="{{ pageTitle.value }}" />
  <GlobalWidgetStringProp id="pageTitle" defaultValue="app title" />
  <Frame
    id="$main"
  ...
  >
    ...
    >
      ...
      >
        <Option id="1dad7" icon="bold/interface-home-3" label="Home" />
        <Option
          id="b1a86"
          icon="bold/interface-user-multiple"
          iconPosition="left"
          itemType="custom"
          label="trigger the drawer"
        >
          <Event
            id="61dfd410"
            event="click"
            ...
            pluginId="triggerDrawer"
            type="datasource"
            waitMs="0"
            waitType="debounce"
          />
        </Option>
        <Option id="2140c" icon="bold/interface-setting-cog" label="Settings" />
      </Navigation>
    </ModuleContainerWidget>
  </Frame>
</App>
